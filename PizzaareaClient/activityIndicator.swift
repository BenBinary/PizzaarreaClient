...
//  PizzaareaClient
//
//  Created by Benedikt Kurz on 05.04.19.
...
public class activityIndicator: UIView, CAAnimationDelegate {
    ...
    private func initialize() {
        ...
        /*
        NotificationCenter.default.addObserver(self, selector: #selector(activityIndicator.resetAnimations), name: NSNotification.Name.UIApplication.didBecomeActiveNotification, object: nil)
        */
